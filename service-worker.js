const CACHE_NAME="sags-v1-87-flight-workspace-20260820-01";
...
self.addEventListener("fetch",event=>{
  ...
  const isFresh=isNavigation||["/version.json","/firebase-config.js","/flight-workspace.js","/index.html","/daily-roster.js","/ai-crosscheck.js","/document-scanner.js","/admin-builder.js","/ac-limits.js","/bbbt-quick-entry.js"].some(x=>url.pathname.endsWith(x));
